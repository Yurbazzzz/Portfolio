function switchTheme (){
    ...
    elem = document.querySelector('#btn2');
    elem.classList.toggle('button-black');

    elem = document.querySelector('#btn3');
    elem.classList.toggle('button-black');

    elem = document.querySelector('#btn4');
    elem.classList.toggle('button-black');

    elem = document.querySelector('#btn5');
    elem.classList.toggle('button-black');

    elem = document.querySelector('#btn6');
    elem.classList.toggle('button-black');
